...
SELECT pg_catalog.setval('public."product_image_embeddings_productImageEmbeddingId_seq"', 5, true);
...
SELECT pg_catalog.setval('public."upload_images_uploadImageId_seq"', 12, true);
