...
2	Duong Hoai Bao	admin@gmail.com	$2b$10$v1Q5Ltn3N78FVqqx4eEJRe5GykpO8TQj1AG5Qt0NwsD5Z4LQXjfmO	0942463758	t	2003-05-25 00:00:00	t	2025-03-09 09:21:09.627+00	2025-04-04 16:49:14.942+00	\N	2
\.
...
1	NGUOIMOI	fixed_amount	50000	0	0	2025-04-01 00:00:00	2025-04-30 00:00:00	100	1	1	2025-04-04 18:07:55.954+00	2025-04-04 18:09:43.196+00
\.
...
SELECT pg_catalog.setval('public."order_addresses_orderAddressId_seq"', 4, true);
...
SELECT pg_catalog.setval('public."order_details_orderDetailId_seq"', 2, true);
...
SELECT pg_catalog.setval('public."price_histories_priceHistoryId_seq"', 5, true);
...
SELECT pg_catalog.setval('public."product_image_embeddings_productImageEmbeddingId_seq"', 12, true);
...
SELECT pg_catalog.setval('public."product_informations_productInfoId_seq"', 5, true);
...
SELECT pg_catalog.setval('public."promotion_periods_promotionPeriodId_seq"', 7, true);
...
SELECT pg_catalog.setval('public."promotions_promotionId_seq"', 3, true);
...
SELECT pg_catalog.setval('public."upload_images_uploadImageId_seq"', 20, true);
